...
namespace ViewROI
{
    ...
    public class HWndCtrl
    {
        ...
        /// </summary>
        private const int MAXNUMOBJLIST = 128;
        ...
        private void fitWindow()
        {
            ...
            double ratio_win = (double)viewPort.Width / (double)viewPort.Height;
            ...
            else
            {
                ...
                zoomWndFactor = (double)w / viewPort.Width;
            }
            //viewPort.HalconWindow.SetPart(_beginRow, _begin_Col, _endRow, _endCol);
            setImagePart(_beginRow, _begin_Col, viewPort.Height, viewPort.Width);
        ...
        private void mouseMoved(object sender, HalconDotNet.HMouseEventArgs e)
        {
            ...
            double posX, posY;
            double zoomZone;
            int a = roiManager.mouseMoveROI(e.X, e.Y);//鼠标经过的index
            if (!mousePressed)
                return;
